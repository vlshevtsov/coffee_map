    ...
    <li id={place.id} className="item">
      <p className="item_title" id={`link-${place.id}`}>
        ...
        <a href={place.website} target="_blank" rel="noreferrer">
          <img src="/coffee_map/img/web_icon.svg" className="item_icon" alt="website icon" width="20" height="20" />
        </a>
      </p>
      <div>
        ...
        <p></p>
        <img src={`/coffee_map/img${place.photo}`} className="item_photo" alt={place.name} />
